...
# Test the model
def evaluate(test_data, model, batch_size):
...
def train(args):
    ...
    model = train_CNN(num_filters, activation, filter_organization, data_augmentation, batch_norm, dropout, batch_size, epochs, train_sampler, val_sampler)
